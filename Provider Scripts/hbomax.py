...
def movie_metadata(item: dict[str, Any], source_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "poster_url": image(images, "poster-with-logo"),
        "fanart_url": image(images, "cover-artwork-horizontal"),
        "thumb_url": "",
        "banner_url": image(images, "default-wide"),
        "logo_url": image(images, "content-logo-polychromatic") or image(images, "content-logo-monochromatic"),
        "gallery_urls": [],
...
def series_metadata(item: dict[str, Any], source_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "poster_url": image(images, "poster-with-logo"), "fanart_url": image(images, "cover-artwork-horizontal"),
        "thumb_url": "", "banner_url": image(images, "default-wide"),
        "logo_url": image(images, "content-logo-polychromatic") or image(images, "content-logo-monochromatic"),
        "gallery_urls": [],
        "genres": string_list(item.get("genres")), "studios": string_list(item.get("brand")),
        **credit_fields(item), "tags": provider_tags(),
